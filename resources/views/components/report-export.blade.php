...
{{-- Usage: @include('components.report-export', ['report' => 'sales', 'params' => ['from' => $startDate, 'to' => $endDate]]) --}}
...
<div class="export-buttons">
    ...
    {{-- Excel Button --}}
    @if(isset($report))
    <a href="{{ route('reports.export', array_merge(['report' => $report, 'format' => 'excel'], $params ?? [])) }}" class="btn-cpos btn-secondary">
