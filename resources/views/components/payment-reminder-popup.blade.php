...
{{-- Include this in your main layout when $paymentReminder is set --}}

@if(isset($paymentReminder) && $paymentReminder['show'] && !session('payment_reminder_dismissed'))
        ...
        <div class="popup-content">
            ...
            <div class="payment-details">
                <div class="detail-row">
                    ...
                    <span class="detail-value">{{ $paymentReminder['billingMonth'] }}</span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Due Date</span>
                    <span class="detail-value text-warning">{{ $paymentReminder['dueDate']->format('F d, Y') }}</span>
                </div>
                <div class="detail-row amount-row">
                    <span class="detail-label">Amount Due</span>
                    <span class="detail-value amount">Rs. {{ number_format($paymentReminder['amount'], 2) }}</span>
                </div>
            </div>
            ...
            <div class="contact-info">
                ...
                <p class="contact-phone">
                    ...
                    {{ $paymentReminder['phone'] ?? '+94 77 123 4567' }}
                </p>
                <p class="contact-email">
                    <i class="bi bi-envelope-fill"></i>
                    {{ $paymentReminder['email'] ?? 'billing@nexfloit.com' }}
                </p>
            </div>
...
function dismissPaymentReminder() {
    ...
    fetch('{{ url("/api/dismiss-payment-reminder") }}', {
        method: 'POST',
        headers: {
