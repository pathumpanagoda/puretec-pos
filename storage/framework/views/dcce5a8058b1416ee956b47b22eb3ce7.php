...
<body class="nexfloit-login-page">
    <div class="login-container">
        <div class="login-card">
            ...
            <form method="POST" action="<?php echo e(route('nexfloit.forgot-password')); ?>">
                <?php echo csrf_field(); ?>
...
<?php /**PATH /home3/motobeatceyloanp/public_html/resources/views/nexfloit/auth/forgot-password.blade.php ENDPATH**/ ?>