...
<div class="page-header">
    ...
    <div class="page-actions">
        <?php echo $__env->make('components.report-export', ['report' => 'summary', 'params' => []], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
</div>
...
<div class="row g-4 mb-4">
    <div class="col-md-3">
        <div class="stat-card stat-green">
            ...
            <div class="stat-value">Rs. <?php echo e(number_format($todaySales, 0)); ?></div>
    ...
    <div class="col-md-3">
        <div class="stat-card stat-blue">
            ...
            <div class="stat-value">Rs. <?php echo e(number_format($monthSales, 0)); ?></div>
    ...
    <div class="col-md-3">
        <div class="stat-card stat-danger">
            ...
            <div class="stat-value">Rs. <?php echo e(number_format($monthExpenses, 0)); ?></div>
...
<div class="row g-4">
        ...
        <div class="cpos-card">
            ...
            <div class="card-body p-4">
                <div class="report-list">
                    <a href="<?php echo e(route('reports.daily')); ?>" class="report-item">
                    ...
                    <a href="<?php echo e(route('reports.sales')); ?>" class="report-item">
                    ...
                    <a href="<?php echo e(route('reports.pos')); ?>" class="report-item">
    ...
    <div class="col-lg-6">
        <div class="cpos-card">
            ...
            <div class="card-body p-4">
                <div class="report-list">
                    <a href="<?php echo e(route('reports.profit')); ?>" class="report-item">
                    ...
                    <a href="<?php echo e(route('reports.cashflow')); ?>" class="report-item">
                    ...
                    <a href="<?php echo e(route('reports.expenses')); ?>" class="report-item">
                    ...
                    <a href="<?php echo e(route('reports.balance-sheet')); ?>" class="report-item">
                    ...
                    <a href="<?php echo e(route('reports.cash-book')); ?>" class="report-item">
    ...
    <div class="col-lg-6">
        <div class="cpos-card">
            ...
            <div class="card-body p-4">
                <div class="report-list">
                    <a href="<?php echo e(route('reports.inventory')); ?>" class="report-item">
                    ...
                    <a href="<?php echo e(route('reports.stock-movements')); ?>" class="report-item">
    ...
    <div class="col-lg-6">
        <div class="cpos-card">
            ...
            <div class="card-body p-4">
                <div class="report-list">
                    <a href="<?php echo e(route('reports.customers')); ?>" class="report-item">
    ...
    <div class="col-lg-6">
        <div class="cpos-card">
            ...
            <div class="card-body p-4">
                <div class="report-list">
                    <a href="<?php echo e(route('reports.sessions')); ?>" class="report-item">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/motobeatceyloanp/public_html/resources/views/reports/index.blade.php ENDPATH**/ ?>