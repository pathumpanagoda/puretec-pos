        ...
        <div class="card cpos-card mb-3">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <input type="text" id="customStoreName" class="form-control" value="<?php echo e($store->name ?? 'PUREPOS'); ?>" onchange="updatePreview()">
                </div>
                <div class="mb-2">
                    <label class="form-label fw-600">Currency Symbol</label>
                    <input type="text" id="currencySymbol" class="form-control" value="<?php echo e($store->currency_symbol ?? 'Rs.'); ?>" onchange="updatePreview()">
                </div>
            </div>
        </div>
        ...
        <div class="card cpos-card mb-3">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <small class="text-muted"><span id="visibleCount"><?php echo e($products->count()); ?></span> visible</small>
                    <div>
