            ...
            if (config.layoutType === 'shelf') {
                html += `<div class="price-tag ${borderClass} ${selectedClass}" 
                    ...
                    <div class="tag-left" style="flex: 1; display: flex; flex-direction: column; align-items: flex-start; min-width: 0; padding-right: 4px;">
                        ...
                        ${showProductName ? `<div class="tag-name" style="font-size:${config.nameFont}pt; font-weight:400; font-family: Arial, sans-serif; color:#000; line-height:1.2; margin-bottom: 2px; word-break: break-word; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; width: 100%;">${escHtml(product.name)}</div>` : ''}
                    ...
                    <div class="tag-right" style="display: flex; flex-direction: column; align-items: flex-end; justify-content: center;">
                        ${showPrice ? `<div class="tag-price" style="font-size:${config.priceFont}pt; font-weight: 400; font-family: Arial, sans-serif; color: #000; line-height: 1; margin: 2px 0;">${escHtml(currency)} ${formatPrice(product.selling_price)}</div>` : ''}
                    </div>
