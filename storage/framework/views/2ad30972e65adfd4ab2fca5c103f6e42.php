...
<div class="modal fade" id="receiptModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content">
            ...
            <div class="receipt-actions p-3 d-flex gap-2">
                <button class="btn btn-outline-secondary flex-fill" onclick="printReceipt()"><i class="bi bi-printer me-1"></i>Print</button>
                <button class="btn btn-primary flex-fill" data-bs-dismiss="modal" onclick="startNewSale()"><i class="bi bi-plus-circle me-1"></i>New Sale</button>
            </div>
        </div>
    </div>
</div>
    ...
    const itemsHtml = cart.map((item, i) => `
        <div class="cart-item" id="cartItem${i}">
            <div class="cart-item-info">
                ...
                <div class="cart-item-price">Rs. ${item.unit_price.toFixed(2)} × ${item.quantity}</div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ceylon-pos\resources\views/pos/index.blade.php ENDPATH**/ ?>