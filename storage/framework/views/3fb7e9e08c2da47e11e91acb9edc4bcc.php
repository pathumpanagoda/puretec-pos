...
<div class="auth-wrapper">
    <div class="auth-card">
        <div class="auth-brand">
            <div class="auth-logo">
                <img src="<?php echo e(asset('icons/logo png.png')); ?>" alt="Logo" class="auth-logo-img">
            </div>
        ...
        <form action="<?php echo e(route('login.post')); ?>" method="POST">
            ...
            <div class="form-group mb-3">
                ...
                <div class="input-icon-wrap">
                    ...
                    <input type="text" name="login" class="form-control form-control-auth" placeholder="admin@purepos.lk" value="<?php echo e(old('login')); ?>" required autofocus>
                </div>
            </div>
            <div class="form-group mb-3">
        ...
        <div class="auth-trademark">
            ...
            <div class="trademark-text">
                <span class="trademark-brand"><span class="text-gold">PURE</span>POS</span> &copy; <?php echo e(date('Y')); ?> <strong>PURETEC</strong>
                <br>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pathu\Desktop\puretec pos\resources\views/auth/login.blade.php ENDPATH**/ ?>