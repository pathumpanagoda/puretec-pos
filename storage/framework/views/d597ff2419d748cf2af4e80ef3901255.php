...
<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('incomes.index')); ?>">Income</a></li>
...
<div class="page-header">
    ...
    <a href="<?php echo e(route('incomes.index')); ?>" class="btn btn-outline-secondary btn-cpos">
                ...
                <div class="card-body p-4">
                    <div class="row g-3">
                        <div class="col-md-8">
                            ...
                            <input type="text" name="title" class="form-control" value="<?php echo e(old('title')); ?>" required placeholder="e.g., Salary Payment, Investment Return">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label required">Amount (Rs.)</label>
                            <input type="number" name="amount" class="form-control" value="<?php echo e(old('amount')); ?>" required min="0.01" step="0.01" placeholder="0.00">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label required">Income Date</label>
                            <input type="date" name="income_date" class="form-control" value="<?php echo e(old('income_date', date('Y-m-d'))); ?>" required>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="received_from" class="form-control" value="<?php echo e(old('received_from')); ?>" placeholder="Person or company name">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Reference Number</label>
                            <input type="text" name="reference_number" class="form-control" value="<?php echo e(old('reference_number')); ?>" placeholder="Cheque no., Transaction ID, etc.">
                        </div>
                        <div class="col-12">
                            <label class="form-label">Notes</label>
                            <textarea name="notes" class="form-control" rows="3" placeholder="Additional notes..."><?php echo e(old('notes')); ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="cpos-card mb-4">
                ...
                <div class="card-body p-4">
                    <div class="form-check form-switch mb-3">
                        <input type="checkbox" name="is_recurring" class="form-check-input" id="isRecurring" <?php echo e(old('is_recurring') ? 'checked' : ''); ?>>
                    ...
                    <div id="recurringOptions" style="display: none;">
                        ...
                        <select name="recurring_interval" class="form-select">
                            <option value="monthly" <?php echo e(old('recurring_interval') == 'monthly' ? 'selected' : ''); ?>>Monthly</option>
                            <option value="weekly" <?php echo e(old('recurring_interval') == 'weekly' ? 'selected' : ''); ?>>Weekly</option>
                            <option value="yearly" <?php echo e(old('recurring_interval') == 'yearly' ? 'selected' : ''); ?>>Yearly</option>
                        </select>
                    </div>
                </div>
            </div>
...
async function addCategory() {
    ...
    try {
        const res = await fetch('<?php echo e(route("incomes.category.store")); ?>', {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/motobeatceyloanp/public_html/resources/views/incomes/create.blade.php ENDPATH**/ ?>