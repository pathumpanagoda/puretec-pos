    ...
    <div class="settings-content">
                    ...
                    <form action="<?php echo e(route('settings.store')); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="name" class="form-control" value="<?php echo e($store->name); ?>" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Business Code</label>
                                <input type="text" name="code" class="form-control" value="<?php echo e($store->code); ?>" placeholder="BRN/Registration">
                            </div>
                            <div class="col-md-12">
                                <label class="form-label">Address</label>
                                <textarea name="address" class="form-control" rows="2"><?php echo e($store->address); ?></textarea>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">City</label>
                                <input type="text" name="city" class="form-control" value="<?php echo e($store->city); ?>">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Country</label>
                                <input type="text" name="country" class="form-control" value="<?php echo e($store->country); ?>">
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" name="email" class="form-control" value="<?php echo e($store->email); ?>">
                            </div>
                            <div class="col-md-6">
                                ...
                                <?php if($store->logo): ?>
                                    <div class="mt-2">
                                        <img src="<?php echo e(asset('storage/' . $store->logo)); ?>" alt="Logo" style="max-height: 60px;" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="currency" class="form-select">
                                    <option value="LKR" <?php echo e($store->currency == 'LKR' ? 'selected' : ''); ?>>Sri Lankan Rupee (LKR)</option>
                                    <option value="USD" <?php echo e($store->currency == 'USD' ? 'selected' : ''); ?>>US Dollar (USD)</option>
                                    <option value="EUR" <?php echo e($store->currency == 'EUR' ? 'selected' : ''); ?>>Euro (EUR)</option>
                                    <option value="GBP" <?php echo e($store->currency == 'GBP' ? 'selected' : ''); ?>>British Pound (GBP)</option>
                                    <option value="INR" <?php echo e($store->currency == 'INR' ? 'selected' : ''); ?>>Indian Rupee (INR)</option>
                                    <option value="AUD" <?php echo e($store->currency == 'AUD' ? 'selected' : ''); ?>>Australian Dollar (AUD)</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Currency Symbol</label>
                                <input type="text" name="currency_symbol" class="form-control" value="<?php echo e($store->currency_symbol ?? 'Rs.'); ?>">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Default Tax Rate (%)</label>
                                <input type="number" name="tax_rate" class="form-control" value="<?php echo e($store->tax_rate ?? 0); ?>" step="0.01">
                            </div>
                        </div>
                        <div class="mt-4">
        ...
        <div class="settings-panel" id="receipt">
            <div class="cpos-card">
                ...
                <div class="card-body p-4">
                    <form action="<?php echo e(route('settings.receipt')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="row g-4">
                            <div class="col-md-6">
                                <label class="form-label">Receipt Header</label>
                                <textarea name="receipt_header" class="form-control" rows="3" placeholder="Text shown at top of receipt"><?php echo e($store->receipt_header); ?></textarea>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Receipt Footer</label>
                                <textarea name="receipt_footer" class="form-control" rows="3" placeholder="Text shown at bottom of receipt"><?php echo e($store->receipt_footer); ?></textarea>
                            </div>
                            <div class="col-md-4">
                                ...
                                <select name="default_print_format" class="form-select">
                                    <optgroup label="Thermal Receipt">
                                        <option value="thermal-58" <?php echo e(($store->settings['default_print_format'] ?? '') == 'thermal-58' ? 'selected' : ''); ?>>58mm Thermal (Small)</option>
                                        <option value="thermal-80" <?php echo e(($store->settings['default_print_format'] ?? 'thermal-80') == 'thermal-80' ? 'selected' : ''); ?>>80mm Thermal (Standard)</option>
                                    </optgroup>
                                    <optgroup label="Invoice (with Logo)">
                                        <option value="a5" <?php echo e(($store->settings['default_print_format'] ?? '') == 'a5' ? 'selected' : ''); ?>>A5 Invoice (Half Page)</option>
                                        <option value="a4" <?php echo e(($store->settings['default_print_format'] ?? '') == 'a4' ? 'selected' : ''); ?>>A4 Invoice (Full Page)</option>
                                        <option value="a3" <?php echo e(($store->settings['default_print_format'] ?? '') == 'a3' ? 'selected' : ''); ?>>A3 Invoice (Large)</option>
                                    </optgroup>
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="receipt_paper_size" class="form-select">
                                    <option value="80mm" <?php echo e(($store->settings['receipt_paper_size'] ?? '80mm') == '80mm' ? 'selected' : ''); ?>>80mm Thermal</option>
                                    <option value="58mm" <?php echo e(($store->settings['receipt_paper_size'] ?? '') == '58mm' ? 'selected' : ''); ?>>58mm Thermal</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Receipt Template</label>
                                <select name="receipt_template" class="form-select">
                                    <option value="standard" <?php echo e(($store->settings['receipt_template'] ?? 'standard') == 'standard' ? 'selected' : ''); ?>>Standard</option>
                                    <option value="compact" <?php echo e(($store->settings['receipt_template'] ?? '') == 'compact' ? 'selected' : ''); ?>>Compact</option>
                                    <option value="detailed" <?php echo e(($store->settings['receipt_template'] ?? '') == 'detailed' ? 'selected' : ''); ?>>Detailed</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Invoice Prefix</label>
                                <input type="text" name="invoice_prefix" class="form-control" value="<?php echo e($store->settings['invoice_prefix'] ?? 'INV-'); ?>" placeholder="INV-">
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" name="print_margin_top" class="form-control" value="<?php echo e($store->settings['print_margin_top'] ?? 3); ?>" min="0" max="50" step="1">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Bottom Margin (mm)</label>
                                <input type="number" name="print_margin_bottom" class="form-control" value="<?php echo e($store->settings['print_margin_bottom'] ?? 3); ?>" min="0" max="50" step="1">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Left Margin (mm)</label>
                                <input type="number" name="print_margin_left" class="form-control" value="<?php echo e($store->settings['print_margin_left'] ?? 3); ?>" min="0" max="50" step="1">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Right Margin (mm)</label>
                                <input type="number" name="print_margin_right" class="form-control" value="<?php echo e($store->settings['print_margin_right'] ?? 3); ?>" min="0" max="50" step="1">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Store Name Font Size</label>
                                <select name="print_font_store_name" class="form-select">
                                    <option value="14" <?php echo e(($store->settings['print_font_store_name'] ?? '16') == '14' ? 'selected' : ''); ?>>Small (14px)</option>
                                    <option value="16" <?php echo e(($store->settings['print_font_store_name'] ?? '16') == '16' ? 'selected' : ''); ?>>Medium (16px)</option>
                                    <option value="18" <?php echo e(($store->settings['print_font_store_name'] ?? '') == '18' ? 'selected' : ''); ?>>Large (18px)</option>
                                    <option value="20" <?php echo e(($store->settings['print_font_store_name'] ?? '') == '20' ? 'selected' : ''); ?>>Extra Large (20px)</option>
                                </select>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Item Font Size</label>
                                <select name="print_font_items" class="form-select">
                                    <option value="10" <?php echo e(($store->settings['print_font_items'] ?? '12') == '10' ? 'selected' : ''); ?>>Small (10px)</option>
                                    <option value="12" <?php echo e(($store->settings['print_font_items'] ?? '12') == '12' ? 'selected' : ''); ?>>Medium (12px)</option>
                                    <option value="14" <?php echo e(($store->settings['print_font_items'] ?? '') == '14' ? 'selected' : ''); ?>>Large (14px)</option>
                                </select>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Total Font Size</label>
                                <select name="print_font_total" class="form-select">
                                    <option value="14" <?php echo e(($store->settings['print_font_total'] ?? '16') == '14' ? 'selected' : ''); ?>>Small (14px)</option>
                                    <option value="16" <?php echo e(($store->settings['print_font_total'] ?? '16') == '16' ? 'selected' : ''); ?>>Medium (16px)</option>
                                    <option value="18" <?php echo e(($store->settings['print_font_total'] ?? '') == '18' ? 'selected' : ''); ?>>Large (18px)</option>
                                </select>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Line Spacing</label>
                                <select name="print_line_spacing" class="form-select">
                                    <option value="1.2" <?php echo e(($store->settings['print_line_spacing'] ?? '1.4') == '1.2' ? 'selected' : ''); ?>>Compact (1.2)</option>
                                    <option value="1.4" <?php echo e(($store->settings['print_line_spacing'] ?? '1.4') == '1.4' ? 'selected' : ''); ?>>Normal (1.4)</option>
                                    <option value="1.6" <?php echo e(($store->settings['print_line_spacing'] ?? '') == '1.6' ? 'selected' : ''); ?>>Relaxed (1.6)</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Receipt Width</label>
                                <select name="print_receipt_width" class="form-select">
                                    <option value="auto" <?php echo e(($store->settings['print_receipt_width'] ?? 'auto') == 'auto' ? 'selected' : ''); ?>>Auto (fit paper)</option>
                                    <option value="58mm" <?php echo e(($store->settings['print_receipt_width'] ?? '') == '58mm' ? 'selected' : ''); ?>>58mm</option>
                                    <option value="72mm" <?php echo e(($store->settings['print_receipt_width'] ?? '') == '72mm' ? 'selected' : ''); ?>>72mm (80mm paper)</option>
                                    <option value="100%" <?php echo e(($store->settings['print_receipt_width'] ?? '') == '100%' ? 'selected' : ''); ?>>Full Width</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Divider Style</label>
                                <select name="print_divider_style" class="form-select">
                                    <option value="dashed" <?php echo e(($store->settings['print_divider_style'] ?? 'dashed') == 'dashed' ? 'selected' : ''); ?>>Dashed Line</option>
                                    <option value="solid" <?php echo e(($store->settings['print_divider_style'] ?? '') == 'solid' ? 'selected' : ''); ?>>Solid Line</option>
                                    <option value="dotted" <?php echo e(($store->settings['print_divider_style'] ?? '') == 'dotted' ? 'selected' : ''); ?>>Dotted Line</option>
                                    <option value="none" <?php echo e(($store->settings['print_divider_style'] ?? '') == 'none' ? 'selected' : ''); ?>>No Divider</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Print Colors</label>
                                <select name="print_colors" class="form-select">
                                    <option value="color" <?php echo e(($store->settings['print_colors'] ?? 'color') == 'color' ? 'selected' : ''); ?>>Color (Blue accents)</option>
                                    <option value="bw" <?php echo e(($store->settings['print_colors'] ?? '') == 'bw' ? 'selected' : ''); ?>>Black & White</option>
                                </select>
                            </div>
                            <div class="col-md-8">
                                <div class="form-check form-switch mb-2">
                                    <input type="checkbox" name="show_logo_on_receipt" class="form-check-input" id="showLogoReceipt" <?php echo e(($store->settings['show_logo_on_receipt'] ?? true) ? 'checked' : ''); ?>>
                                    <label class="form-check-label" for="showLogoReceipt">Show logo on receipt</label>
                                </div>
                                <div class="form-check form-switch mb-2">
                                    <input type="checkbox" name="show_tax_breakdown" class="form-check-input" id="showTaxBreakdown" <?php echo e(($store->settings['show_tax_breakdown'] ?? true) ? 'checked' : ''); ?>>
                                    <label class="form-check-label" for="showTaxBreakdown">Show tax breakdown on receipt</label>
                                </div>
                                <div class="form-check form-switch mb-2">
                                    <input type="checkbox" name="auto_print_receipt" class="form-check-input" id="autoPrintReceipt" <?php echo e(($store->settings['auto_print_receipt'] ?? false) ? 'checked' : ''); ?>>
                                    <label class="form-check-label" for="autoPrintReceipt">Auto-print receipt after sale</label>
                                </div>
                                <div class="form-check form-switch">
                                    <input type="checkbox" name="print_duplicate" class="form-check-input" id="printDuplicate" <?php echo e(($store->settings['print_duplicate'] ?? false) ? 'checked' : ''); ?>>
                                    ...
                                    <div id="receiptPreview" class="receipt-preview-content">
                                        <div class="receipt-paper" id="previewPaper">
                                            <div class="receipt-header">
                                                <h3 class="store-name" id="previewStoreName"><?php echo e($store->name); ?></h3>
                                                <?php if($store->address): ?><p class="store-detail"><?php echo e($store->address); ?></p><?php endif; ?>
                                                <?php if($store->phone): ?><p class="store-detail">Tel: <?php echo e($store->phone); ?></p><?php endif; ?>
                                            </div>
                                            <hr class="receipt-divider" id="previewDivider1">
                                            <div class="receipt-meta">
                                                <div><span class="meta-label">Order:</span> ORD-20240101-001</div>
                                                <div><span class="meta-label">Date:</span> <?php echo e(date('d/m/Y, H:i:s')); ?></div>
                                            ...
                                            <div class="receipt-footer">
                                                <p class="footer-thanks"><?php echo e($store->receipt_footer ?? 'Thank you for your business!'); ?></p>
            ...
            <div class="row g-4">
                ...
                <div class="col-12">
                    <div class="cpos-card">
                        ...
                        <div class="card-body p-4">
                            ...
                            <form action="<?php echo e(route('settings.devices')); ?>" method="POST" id="printerForm">
                                <?php echo csrf_field(); ?>
                                <div id="printerList">
                                    <?php $printers = $store->settings['printers'] ?? []; ?>
                                    <?php $__empty_1 = true; $__currentLoopData = $printers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $printer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="device-card" data-printer="<?php echo e($index); ?>">
                                        <div class="device-header">
                                            <div class="device-info">
                                                <i class="bi bi-printer device-icon"></i>
                                                <div>
                                                    <input type="text" name="printers[<?php echo e($index); ?>][name]" class="form-control form-control-sm" value="<?php echo e($printer['name']); ?>" placeholder="Printer Name">
                                                </div>
                                            </div>
                                            <button type="button" class="btn btn-sm btn-outline-danger" onclick="removePrinter(<?php echo e($index); ?>)">
                                        ...
                                        <div class="device-body">
                                            <div class="row g-3">
                                                <div class="col-md-3">
                                                    ...
                                                    <select name="printers[<?php echo e($index); ?>][type]" class="form-select form-select-sm" onchange="updatePrinterFields(this, <?php echo e($index); ?>)">
                                                        <option value="usb" <?php echo e(($printer['type'] ?? '') == 'usb' ? 'selected' : ''); ?>>USB</option>
                                                        <option value="network" <?php echo e(($printer['type'] ?? '') == 'network' ? 'selected' : ''); ?>>Network/IP</option>
                                                        <option value="bluetooth" <?php echo e(($printer['type'] ?? '') == 'bluetooth' ? 'selected' : ''); ?>>Bluetooth</option>
                                                        <option value="wifi" <?php echo e(($printer['type'] ?? '') == 'wifi' ? 'selected' : ''); ?>>WiFi Direct</option>
                                                        <option value="cloud" <?php echo e(($printer['type'] ?? '') == 'cloud' ? 'selected' : ''); ?>>Cloud Print</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-3">
                                                    <label class="form-label small">Paper Size</label>
                                                    <select name="printers[<?php echo e($index); ?>][paper_size]" class="form-select form-select-sm">
                                                        <option value="80mm" <?php echo e(($printer['paper_size'] ?? '') == '80mm' ? 'selected' : ''); ?>>80mm Thermal</option>
                                                        <option value="58mm" <?php echo e(($printer['paper_size'] ?? '') == '58mm' ? 'selected' : ''); ?>>58mm Thermal</option>
                                                        <option value="A4" <?php echo e(($printer['paper_size'] ?? '') == 'A4' ? 'selected' : ''); ?>>A4</option>
                                                        <option value="A5" <?php echo e(($printer['paper_size'] ?? '') == 'A5' ? 'selected' : ''); ?>>A5</option>
                                                        <option value="A3" <?php echo e(($printer['paper_size'] ?? '') == 'A3' ? 'selected' : ''); ?>>A3</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-3 printer-ip-field" style="<?php echo e(($printer['type'] ?? '') == 'network' ? '' : 'display:none'); ?>">
                                                    <label class="form-label small">IP Address</label>
                                                    <input type="text" name="printers[<?php echo e($index); ?>][ip_address]" class="form-control form-control-sm" value="<?php echo e($printer['ip_address'] ?? ''); ?>" placeholder="192.168.1.100">
                                                </div>
                                                <div class="col-md-3 printer-port-field" style="<?php echo e(($printer['type'] ?? '') == 'network' ? '' : 'display:none'); ?>">
                                                    <label class="form-label small">Port</label>
                                                    <input type="number" name="printers[<?php echo e($index); ?>][port]" class="form-control form-control-sm" value="<?php echo e($printer['port'] ?? '9100'); ?>" placeholder="9100">
                                                </div>
                                                <div class="col-md-3">
                                                    <label class="form-label small">Usage</label>
                                                    <select name="printers[<?php echo e($index); ?>][usage]" class="form-select form-select-sm">
                                                        <option value="receipt" <?php echo e(($printer['usage'] ?? '') == 'receipt' ? 'selected' : ''); ?>>Receipt Printer</option>
                                                        <option value="invoice" <?php echo e(($printer['usage'] ?? '') == 'invoice' ? 'selected' : ''); ?>>Invoice Printer</option>
                                                        <option value="kitchen" <?php echo e(($printer['usage'] ?? '') == 'kitchen' ? 'selected' : ''); ?>>Kitchen Display</option>
                                                        <option value="label" <?php echo e(($printer['usage'] ?? '') == 'label' ? 'selected' : ''); ?>>Label Printer</option>
                                                        <option value="report" <?php echo e(($printer['usage'] ?? '') == 'report' ? 'selected' : ''); ?>>Report Printer</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-3">
                                                    <label class="form-label small">Status</label>
                                                    <div class="form-check form-switch mt-2">
                                                        <input type="checkbox" name="printers[<?php echo e($index); ?>][enabled]" class="form-check-input" <?php echo e(($printer['enabled'] ?? true) ? 'checked' : ''); ?>>
                                                        <label class="form-check-label">Enabled</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <label class="form-label small">&nbsp;</label>
                                                    <button type="button" class="btn btn-sm btn-outline-primary w-100" onclick="testPrinter(<?php echo e($index); ?>)">
                                                        <i class="bi bi-printer"></i> Test Print
                                                    </button>
                                                </div>
                                            </div>
                ...
                <div class="col-md-6">
                    <div class="cpos-card">
                        ...
                        <div class="card-body p-4">
                            <form action="<?php echo e(route('settings.scanner')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="mb-3">
                ...
                <div class="col-md-6">
                    <div class="cpos-card">
                        ...
                        <div class="card-body p-4">
                            <form action="<?php echo e(route('settings.cardreader')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="mb-3">
                ...
                <div class="col-md-6">
                    <div class="cpos-card">
                        ...
                        <div class="card-body p-4">
                            <form action="<?php echo e(route('settings.cashdrawer')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="mb-3">
                ...
                <div class="col-md-6">
                    <div class="cpos-card">
                        ...
                        <div class="card-body p-4">
                            <form action="<?php echo e(route('settings.display')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="mb-3">
        ...
        <div class="settings-panel" id="pos">
            <div class="cpos-card">
                ...
                <div class="card-body p-4">
                    <form action="<?php echo e(route('settings.pos')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="row g-4">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="default_customer" class="form-select">
                                    ...
                                    <?php $__currentLoopData = \App\Models\Customer::where('store_id', auth()->user()->store_id)->limit(50)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="col-12">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <?php $posSettings = $store->settings['pos'] ?? []; ?>
                                        <div class="form-check form-switch mb-2">
                                            <input type="checkbox" name="allow_negative_stock" class="form-check-input" id="allowNegStock" <?php echo e(($posSettings['allow_negative_stock'] ?? false) ? 'checked' : ''); ?>>
                                            <label class="form-check-label" for="allowNegStock">Allow negative stock sales</label>
                                        </div>
                                        <div class="form-check form-switch mb-2">
                                            <input type="checkbox" name="require_customer" class="form-check-input" id="requireCustomer" <?php echo e(($posSettings['require_customer'] ?? false) ? 'checked' : ''); ?>>
                                            <label class="form-check-label" for="requireCustomer">Require customer for each sale</label>
                                        </div>
                                        <div class="form-check form-switch mb-2">
                                            <input type="checkbox" name="allow_discounts" class="form-check-input" id="allowDiscounts" <?php echo e(($posSettings['allow_discounts'] ?? true) ? 'checked' : ''); ?>>
                                            <label class="form-check-label" for="allowDiscounts">Allow discounts at POS</label>
                                        </div>
                                        <div class="form-check form-switch mb-2">
                                            <input type="checkbox" name="allow_price_edit" class="form-check-input" id="allowPriceEdit" <?php echo e(($posSettings['allow_price_edit'] ?? false) ? 'checked' : ''); ?>>
                                            <label class="form-check-label" for="allowPriceEdit">Allow price editing at POS</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-check form-switch mb-2">
                                            <input type="checkbox" name="show_stock" class="form-check-input" id="showStock" <?php echo e(($posSettings['show_stock'] ?? true) ? 'checked' : ''); ?>>
                                            <label class="form-check-label" for="showStock">Show stock quantity on POS</label>
                                        </div>
                                        <div class="form-check form-switch mb-2">
                                            <input type="checkbox" name="confirm_checkout" class="form-check-input" id="confirmCheckout" <?php echo e(($posSettings['confirm_checkout'] ?? true) ? 'checked' : ''); ?>>
                                            <label class="form-check-label" for="confirmCheckout">Confirm before checkout</label>
                                        </div>
                                        <div class="form-check form-switch mb-2">
                                            <input type="checkbox" name="sound_effects" class="form-check-input" id="soundEffects" <?php echo e(($posSettings['sound_effects'] ?? true) ? 'checked' : ''); ?>>
                                            <label class="form-check-label" for="soundEffects">Enable sound effects</label>
                                        </div>
                                        <div class="form-check form-switch mb-2">
                                            <input type="checkbox" name="hold_orders" class="form-check-input" id="holdOrders" <?php echo e(($posSettings['hold_orders'] ?? true) ? 'checked' : ''); ?>>
                        ...
                        <div class="col-md-4 text-end">
                            <div class="form-check form-switch form-switch-lg d-inline-block">
                                <input type="checkbox" class="form-check-input" id="seasonModeToggle"
                                       <?php echo e(($store->settings['season_mode'] ?? false) ? 'checked' : ''); ?>

                                       onchange="toggleSeasonMode(this.checked)"
                                       style="width: 3rem; height: 1.5rem;">
                                <label class="form-check-label ms-2" for="seasonModeToggle" id="seasonModeLabel">
                                    <?php echo e(($store->settings['season_mode'] ?? false) ? 'ON' : 'OFF'); ?>

                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="alert <?php echo e(($store->settings['season_mode'] ?? false) ? 'alert-success' : 'alert-warning'); ?> mt-3 mb-0" id="seasonModeAlert">
                        <?php if($store->settings['season_mode'] ?? false): ?>
        ...
        <div class="settings-panel" id="tax">
            <div class="cpos-card">
                ...
                <div class="card-body p-4">
                    <form action="<?php echo e(route('settings.tax')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="table-responsive">
                            <table class="table table-cpos" id="taxTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <input type="hidden" name="taxes[<?php echo e($tax->id); ?>][id]" value="<?php echo e($tax->id); ?>">
                                            <input type="text" name="taxes[<?php echo e($tax->id); ?>][name]" class="form-control form-control-sm" value="<?php echo e($tax->name); ?>">
                                        </td>
                                        <td>
                                            <input type="number" name="taxes[<?php echo e($tax->id); ?>][rate]" class="form-control form-control-sm" value="<?php echo e($tax->rate); ?>" step="0.01">
                                        </td>
                                        <td>
                                            <select name="taxes[<?php echo e($tax->id); ?>][type]" class="form-select form-select-sm">
                                                <option value="percentage" <?php echo e($tax->type == 'percentage' ? 'selected' : ''); ?>>Percentage</option>
                                                <option value="fixed" <?php echo e($tax->type == 'fixed' ? 'selected' : ''); ?>>Fixed Amount</option>
                                            </select>
                                        </td>
                                        <td>
                                            <select name="taxes[<?php echo e($tax->id); ?>][apply_to]" class="form-select form-select-sm">
                                                <option value="all" <?php echo e(($tax->apply_to ?? 'all') == 'all' ? 'selected' : ''); ?>>All Products</option>
                                                <option value="taxable" <?php echo e(($tax->apply_to ?? '') == 'taxable' ? 'selected' : ''); ?>>Taxable Only</option>
                                            </select>
                                        </td>
                                        <td>
                                            <div class="form-check form-switch">
                                                <input type="checkbox" name="taxes[<?php echo e($tax->id); ?>][is_active]" class="form-check-input" <?php echo e($tax->is_active ? 'checked' : ''); ?>>
                                            </div>
                                        </td>
                                        <td>
        ...
        <div class="settings-panel" id="inventory">
            <div class="cpos-card">
                ...
                <div class="card-body p-4">
                    <form action="<?php echo e(route('settings.inventory')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="row g-4">
                            <div class="col-md-4">
                    ...
                    <form action="<?php echo e(route('settings.notifications')); ?>" method="POST">
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" name="notification_email" class="form-control" value="<?php echo e($store->email); ?>" placeholder="admin@yourstore.com">
                            </div>
                        </div>
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="cpos-card">
                        ...
                        <div class="card-body p-4">
                            ...
                            <a href="<?php echo e(route('settings.backup.download')); ?>" class="btn-cpos btn-primary w-100">
                ...
                <div class="col-md-6">
                    <div class="cpos-card">
                        ...
                        <div class="card-body p-4">
                            <form action="<?php echo e(route('settings.backup.schedule')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="mb-3">
                ...
                <div class="col-md-6">
                    <div class="cpos-card border-danger">
                        ...
                        <div class="card-body p-4">
                            ...
                            <form action="<?php echo e(route('settings.reset')); ?>" method="POST" id="resetForm">
                                <?php echo csrf_field(); ?>
                                <div class="mb-3">
...
async function toggleSeasonMode(enabled) {
    ...
    try {
        const res = await fetch('<?php echo e(route("settings.season-mode")); ?>', {
            method: 'POST',
            headers: {
...
// Add printer
let printerIndex = <?php echo e(count($store->settings['printers'] ?? [])); ?>;
function addPrinter() {
...
// Add tax row
let taxIndex = <?php echo e($taxes->count()); ?>;
function addTaxRow() {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/motobeatceyloanp/public_html/resources/views/settings/index.blade.php ENDPATH**/ ?>