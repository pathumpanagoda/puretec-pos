        ...
        <div class="card cpos-card mb-4">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <input type="text" name="name" id="productName" class="form-control <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('name')); ?>" required autocomplete="off">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <input type="text" name="sku" id="skuInput" class="form-control text-mono" value="<?php echo e(old('sku', $nextSku)); ?>">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="barcode" id="barcodeInput" class="form-control text-mono" value="<?php echo e(old('barcode')); ?>" placeholder="Scan barcode here..." autocomplete="off" autofocus>
                ...
                <div class="mt-3">
                    ...
                    <textarea name="description" class="form-control" rows="3" placeholder="Optional product description"><?php echo e(old('description')); ?></textarea>
                </div>
            </div>
        </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('selling_price', 0)); ?>" step="0.01" min="0" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Cost Price (Rs.)</label>
                        <input type="number" name="cost_price" class="form-control" value="<?php echo e(old('cost_price', 0)); ?>" step="0.01" min="0">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Wholesale Price (Rs.)</label>
                        <input type="number" name="wholesale_price" class="form-control" value="<?php echo e(old('wholesale_price')); ?>" step="0.01" min="0">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Min Selling Price (Rs.)</label>
                        <input type="number" name="min_selling_price" class="form-control" value="<?php echo e(old('min_selling_price')); ?>" step="0.01" min="0">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card cpos-card mb-4">
            ...
            <div class="card-body">
                <div class="form-check form-switch mb-3">
                    <input type="checkbox" name="track_stock" class="form-check-input" id="trackStock" value="1" <?php echo e(old('track_stock', 1) ? 'checked' : ''); ?>>
                    <label class="form-check-label" for="trackStock">Track Stock</label>
                </div>
                <div class="row g-3">
                    <div class="col-md-4">
                        <label class="form-label">Opening Stock</label>
                        <input type="number" name="stock_quantity" class="form-control" value="<?php echo e(old('stock_quantity', 0)); ?>" step="0.001" min="0">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Min Stock (Alert)</label>
                        <input type="number" name="min_stock" class="form-control" value="<?php echo e(old('min_stock', 0)); ?>" step="0.001" min="0">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Reorder Level</label>
                        <input type="number" name="reorder_level" class="form-control" value="<?php echo e(old('reorder_level', 0)); ?>" step="0.001" min="0">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Unit</label>
                        <select name="unit" class="form-select">
                            <?php $__currentLoopData = ['pcs','kg','g','litre','ml','m','cm','box','pack','dozen','pair','set']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($u); ?>" <?php echo e(old('unit','pcs') === $u ? 'selected' : ''); ?>><?php echo e(strtoupper($u)); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Storage Location</label>
                        <input type="text" name="location" class="form-control" value="<?php echo e(old('location')); ?>" placeholder="e.g., Shelf A-1">
                    </div>
                    <div class="col-md-4">
                ...
                <div class="form-check form-switch mt-2">
                    <input type="checkbox" name="allow_negative_stock" class="form-check-input" id="allowNegative" value="1" <?php echo e(old('allow_negative_stock') ? 'checked' : ''); ?>>
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <select name="category_id" id="categorySelect" class="form-select">
                            ...
                            <option value="<?php echo e($cat->id); ?>" data-code="<?php echo e($cat->code); ?>" <?php echo e(old('category_id') == $cat->id ? 'selected' : ''); ?>><?php echo e($cat->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                ...
                <div class="mb-3">
                    ...
                    <select name="tax_id" class="form-select">
                        ...
                        <option value="<?php echo e($tax->id); ?>" <?php echo e(old('tax_id') == $tax->id ? 'selected' : ''); ?>><?php echo e($tax->name); ?> (<?php echo e($tax->rate); ?>%)</option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
            </div>
        ...
        <div class="card cpos-card mb-4">
            ...
            <div class="card-body">
                <div class="form-check form-switch mb-2">
                    ...
                    <input type="checkbox" name="is_active" class="form-check-input" value="1" <?php echo e(old('is_active', 1) ? 'checked' : ''); ?>>
                    <label class="form-check-label">Active (visible in POS)</label>
                </div>
                <div class="form-check form-switch mb-2">
                    <input type="hidden" name="is_taxable" value="0">
                    <input type="checkbox" name="is_taxable" class="form-check-input" value="1" <?php echo e(old('is_taxable', 1) ? 'checked' : ''); ?>>
                    <label class="form-check-label">Taxable</label>
                </div>
                <div class="form-check form-switch">
                    <input type="hidden" name="is_featured" value="0">
                    <input type="checkbox" name="is_featured" class="form-check-input" value="1" <?php echo e(old('is_featured') ? 'checked' : ''); ?>>
...
async function generateSku() {
    ...
    const url = '<?php echo e(route("products.sku")); ?>?' + params.toString();
...
async function loadSubCategories(parentId) {
    ...
    const res = await fetch('<?php echo e(route("products.sub-categories")); ?>?parent_id=' + parentId);
    const data = await res.json();
...
document.getElementById('productName').addEventListener('input', function() {
    ...
    if (name.length >= 3) {
        nameTimeout = setTimeout(async () => {
            // Suggest category
            const res = await fetch('<?php echo e(route("products.suggest-category")); ?>?name=' + encodeURIComponent(name));
            const data = await res.json();
...
async function lookupBarcode(barcode) {
    ...
    try {
        ...
        const localRes = await fetch('<?php echo e(route("products.search-barcode")); ?>?barcode=' + encodeURIComponent(barcode));
...
async function suggestCategoryCode() {
    ...
    const res = await fetch('<?php echo e(route("categories.suggest-code")); ?>?name=' + encodeURIComponent(name));
    const data = await res.json();
...
async function saveQuickCategory() {
    ...
    try {
        const res = await fetch('<?php echo e(route("categories.quick")); ?>', {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/motobeatceyloanp/public_html/resources/views/products/create.blade.php ENDPATH**/ ?>