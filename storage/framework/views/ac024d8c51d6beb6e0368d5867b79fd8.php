...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> — PUREPOS</title>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/pure-pos.css')); ?>">
...
<nav id="sidebar" class="cpos-sidebar">
    ...
    <div class="sidebar-store">
        ...
        <div class="store-info">
            <div class="store-name"><?php echo e(auth()->user()->store?->name ?? 'PUREPOS'); ?></div>
...
<script src="<?php echo e(asset('js/pure-pos.js')); ?>"></script>
...
const savedTheme  = localStorage.getItem('pure-pos-theme') || 'dark';
...
if (themeToggle) {
    themeToggle.addEventListener('click', () => {
        ...
        localStorage.setItem('pure-pos-theme', next);
