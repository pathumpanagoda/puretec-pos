...
<head>
    ...
    <title>Customer Display - <?php echo e($store?->name ?? 'Pure POS'); ?></title>
...
<body>
    <div class="header"><?php echo e($store?->name ?? 'Pure POS'); ?></div>
    ...
    <script>
        const storeName = <?php echo json_encode($store?->name ?? 'Pure POS', 15, 512) ?>;
...
<?php /**PATH C:\Users\pathu\Desktop\puretec pos\resources\views/pos/customer-display.blade.php ENDPATH**/ ?>