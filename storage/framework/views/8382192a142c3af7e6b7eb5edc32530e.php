...
<head>
    ...
    <title>Customer Display - <?php echo e($store?->name ?? 'Ceyloan POS'); ?></title>
...
<body>
    <div class="header"><?php echo e($store?->name ?? 'Ceyloan POS'); ?></div>
    ...
    <script>
        const storeName = <?php echo json_encode($store?->name ?? 'Ceyloan POS', 15, 512) ?>;
...
<?php /**PATH /home3/motobeatceyloanp/public_html/resources/views/pos/customer-display.blade.php ENDPATH**/ ?>