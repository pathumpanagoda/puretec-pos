...
<div class="page-header">
    <div>
        ...
        <p class="page-subtitle"><?php echo e($expense->title); ?></p>
    </div>
...
unset($__errorArgs, $__bag); ?>"
                                       value="<?php echo e(old('amount', $expense->amount)); ?>" step="0.01" min="0.01" required>
                            </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="cpos-card">
                ...
                <div class="card-body p-4">
                    <textarea name="notes" class="form-control" rows="3"><?php echo e(old('notes', $expense->notes)); ?></textarea>
                </div>
            </div>
        </div>
            ...
            <div class="cpos-card mb-4">
                ...
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between mb-2">
                        ...
                        <span><?php echo e($expense->created_at->format('M d, Y')); ?></span>
                    </div>
                    <div class="d-flex justify-content-between mb-2">
                        <span class="text-muted">Added By:</span>
                        <span><?php echo e($expense->user?->name ?? '-'); ?></span>
                    </div>
                    <?php if($expense->updated_at->ne($expense->created_at)): ?>
                    <div class="d-flex justify-content-between">
                        <span class="text-muted">Last Updated:</span>
                        <span><?php echo e($expense->updated_at->format('M d, Y')); ?></span>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/motobeatceyloanp/public_html/resources/views/expenses/edit.blade.php ENDPATH**/ ?>